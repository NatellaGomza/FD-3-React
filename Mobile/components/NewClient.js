    ...
    return (
      <tr style={{ display: this.state.delete ? 'none' : ''}}>
        <td className='MobileClientFIO'>
          ...
          <input type='text' defaultValue={this.state.FIO.fam} ref={this.setNewClientFam} name="surname"></input>
        </td>
        <td className='MobileClientFIO'>

          <input type='text' defaultValue={this.state.FIO.im} ref={this.setNewClientIm} name="name"></input>
        </td>
        <td className='MobileClientFIO'>

          <input type='text' defaultValue={this.state.FIO.otch} ref={this.setNewClientOtch} name="patronymic"></input>
        </td>
        <td >
          <input type='text' defaultValue={this.state.balance} ref={this.setNewClientBalance} name="balance"></input>
        </td>
